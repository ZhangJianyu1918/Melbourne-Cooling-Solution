        ...
        <el-collapse-item name="2">
          ...
          <el-card shadow="never" class="info-card">
            <el-steps direction="vertical" :space="100">
              <el-step title="Move to Shade" description="Move the person to a shaded or air-conditioned area." />
              <el-step title="Loosen Clothing" description="Loosen tight clothing and remove excess layers." />
              <el-step title="Provide Water" description="Provide cool water if they are conscious and able to drink." />
              <el-step title="Cool Down" description="Use cool damp cloths, fans, or cold packs to lower body temperature." />
              <el-step title="Call Emergency" description="Call emergency services (000) if symptoms worsen." />
            </el-steps>
          </el-card>
        </el-collapse-item>
      ...
      <el-card class="mb-6" shadow="hover">
        ...
        <el-descriptions border>
          <el-descriptions-item label="VicEmergency Hotline">
            <el-button type="warning" size="small" plain icon="el-icon-phone" @click="callNumber('1800 226 226')">
              1800 226 226
            </el-button>
