    ...
    <div class="container mx-auto p-6">
        ...
        <el-collapse accordion class="custom-collapse">
            ...
            <el-collapse-item name="1">
                ...
                <el-card class="mb-4 info-card" shadow="never">
                    <p>
                        ...
                        <el-tag type="danger">000</el-tag> for immediate assistance in life-threatening or time-critical
                        emergencies.
            ...
            <el-collapse-item name="2">
                ...
                <el-card class="mb-4 info-card" shadow="never">
                    <p>
                        ...
                        <el-tag>131 444</el-tag> for non-urgent police matters such as reporting a crime that has
                        already occurred,
            ...
            <el-collapse-item name="3">
                ...
                <el-card class="mb-4 info-card" shadow="never">
                    <p>
                        ...
                        <el-tag>132 500</el-tag> for non-life-threatening situations related to natural disasters.
                    </p>
                </el-card>
            </el-collapse-item>
            ...
            <el-collapse-item name="7">
                ...
                <el-card class="mb-4 info-card" shadow="never">
                    <p>
                        <strong>Mobile Phones:</strong> Dial <el-tag>112</el-tag> — redirects to <strong>000</strong> in
                        Australia.
                    </p>
                    <p>
